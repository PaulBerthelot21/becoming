...
-- CreateIndex
CREATE INDEX "habit_completion_habitId_idx" ON "habit_completion"("habitId");

-- CreateIndex
CREATE UNIQUE INDEX "habit_completion_habitId_date_key" ON "habit_completion"("habitId", "date");
